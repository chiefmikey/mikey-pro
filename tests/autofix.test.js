...
const coreConfigFile = join(rootDir, 'configs', 'eslint-config', 'index.js');
...
describe('ESLint Auto-Fix — unicorn plugin', () => {
  it('should auto-fix unicorn/prefer-string-slice without crashing', async () => {
  ...
  it('should auto-fix unicorn/prefer-node-protocol without crashing', async () => {
  ...
  it('should auto-fix unicorn/prefer-includes without crashing', async () => {
  ...
  it('should auto-fix unicorn/prefer-string-replace-all without crashing', async () => {
...
describe('ESLint Auto-Fix — simple-import-sort plugin', () => {
  it('should auto-fix simple-import-sort/imports without crashing', async () => {
  ...
  it('should auto-fix simple-import-sort/exports without crashing', async () => {
...
describe('ESLint Auto-Fix — prettier plugin', () => {
  it('should auto-fix prettier/prettier formatting without crashing', async () => {
...
describe('ESLint Auto-Fix — perfectionist plugin', () => {
  it('should auto-fix perfectionist/sort-imports without crashing', async () => {
  ...
  it('should auto-fix perfectionist/sort-named-exports without crashing', async () => {
...
describe('ESLint Auto-Fix — import-x plugin', () => {
  it('should auto-fix import-x/first without crashing', async () => {
  ...
  it('should auto-fix import-x/newline-after-import without crashing', async () => {
...
describe('ESLint Auto-Fix — @typescript-eslint plugin', () => {
  ...
  it('should auto-fix @typescript-eslint/prefer-as-const in .ts files without crashing', async () => {
  ...
  it('should auto-fix @typescript-eslint/no-useless-constructor without crashing', async () => {
...
describe('ESLint Auto-Fix — React config', () => {
  it('should auto-fix unicorn/prefer-string-slice in React files without crashing', async () => {
    const code = [
  ...
  it('should auto-fix prettier formatting in React files without crashing', async () => {
    const code = [
      `import React from 'react'`,
      ``,
  ...
  it('should auto-fix simple-import-sort in React files without crashing', async () => {
    const code = [
...
describe('ESLint Auto-Fix — fixer output integrity', () => {
  it('should produce parseable JS output after fixing prefer-string-slice', async () => {
  ...
  it('should not crash when applying multiple fixable rules simultaneously', async () => {
